...
import {
  ...
  workspaceSchema, createWorkspaceInputSchema, updateWorkspaceInputSchema, searchWorkspacesInputSchema,
  membershipSchema, createMembershipInputSchema, updateMembershipInputSchema, searchMembershipsInputSchema,
  accountSchema, createAccountInputSchema, updateAccountInputSchema, searchAccountsInputSchema,
  campaignSchema, createCampaignInputSchema, updateCampaignInputSchema, searchCampaignsInputSchema,
  adSetSchema, createAdSetInputSchema, updateAdSetInputSchema, searchAdSetsInputSchema,
  adSchema, createAdInputSchema, updateAdInputSchema, searchAdsInputSchema,
  metricsDailySchema, createMetricsDailyInputSchema, searchMetricsDailyInputSchema,
  uploadJobSchema, createUploadJobInputSchema, updateUploadJobInputSchema, searchUploadJobsInputSchema,
  mappingTemplateSchema, createMappingTemplateInputSchema, updateMappingTemplateInputSchema, searchMappingTemplatesInputSchema,
  alertRuleSchema, createAlertRuleInputSchema, updateAlertRuleInputSchema, searchAlertRulesInputSchema,
  alertTriggerSchema, createAlertTriggerInputSchema, updateAlertTriggerInputSchema, searchAlertTriggersInputSchema,
  ...
  sharedLinkSchema, createSharedLinkInputSchema, updateSharedLinkInputSchema, searchSharedLinksInputSchema,
  exportJobSchema, createExportJobInputSchema, updateExportJobInputSchema, searchExportJobsInputSchema,
  anomalyDetectionSchema, createAnomalyDetectionInputSchema, updateAnomalyDetectionInputSchema, searchAnomalyDetectionsInputSchema,
  creativePerformanceSchema, createCreativePerformanceInputSchema, updateCreativePerformanceInputSchema, searchCreativePerformanceInputSchema,
...
app.get('/api/workspaces/:workspace_id/anomalies', authenticateToken, validateWorkspaceAccess, async (req, res) => {
  try {
    const { 
      date_preset, is_reviewed, severity, metric_type,
...
app.get('/api/workspaces/:workspace_id/campaigns', authenticateToken, validateWorkspaceAccess, async (req, res) => {
  try {
    const { 
      search_query, platforms, accounts, status_filter, objective,
      page = 1, per_page = 50, limit = 10, offset = 0,
...
app.get('/api/workspaces/:workspace_id/creatives', authenticateToken, validateWorkspaceAccess, async (req, res) => {
  try {
    const { 
      performance_filter, sort_by = 'total_spend', platforms, creative_tags, ad_format,
      date_from, date_to, query, min_spend, max_spend,
...
app.get('/api/workspaces/:workspace_id/uploads', authenticateToken, validateWorkspaceAccess, async (req, res) => {
  try {
    const { 
      status_filter, platform_filter, search_query,
      page = 1, limit = 10, offset = 0, sort_by = 'created_at', sort_order = 'desc'
    } = req.query;
...
app.get('/api/workspaces/:workspace_id/mapping-templates', authenticateToken, validateWorkspaceAccess, async (req, res) => {
  try {
    const { 
      platform, is_default, is_shared, query,
      limit = 10, offset = 0, sort_by = 'created_at', sort_order = 'desc'
    } = req.query;
...
app.get('/api/workspaces/:workspace_id/alert-rules', authenticateToken, validateWorkspaceAccess, async (req, res) => {
  try {
    const { 
      metric, severity, is_active, query,
      limit = 10, offset = 0, sort_by = 'created_at', sort_order = 'desc'
    } = req.query;
...
app.post('/api/workspaces/:workspace_id/alert-rules', authenticateToken, validateWorkspaceAccess, async (req, res) => {
  try {
    ...
    const {
      name, metric, condition, threshold, threshold_percentage, time_window = 'daily',
      platform_filter, account_filter, campaign_filter, severity = 'warning',
      is_active = true, notification_email = true, notification_in_app = true,
      cooldown_minutes = 60
    } = validation.data;
...
app.get('/api/workspaces/:workspace_id/alert-triggers', authenticateToken, validateWorkspaceAccess, async (req, res) => {
  try {
    const { 
      alert_rule_id, platform, is_resolved, affected_entity_type,
      limit = 10, offset = 0, sort_by = 'triggered_at', sort_order = 'desc'
    } = req.query;
...
app.post('/api/workspaces/:workspace_id/exports', authenticateToken, validateWorkspaceAccess, async (req, res) => {
  try {
    ...
    const {
      export_type, format, filters, date_from, date_to, platforms, accounts
    } = validation.data;
